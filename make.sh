...
$CC -std=c++17 -Iinclude -I../include -DLIBLOG_LOG_TAG=1006 -DSNET_EVENT_LOG_TAG=1397638484 ${CFLAGS} -c log_event_list.cpp log_event_write.cpp logger_name.cpp logger_read.cpp logger_write.cpp logprint.cpp properties.cpp ${src}
...
$CC -std=c++17 -I../include ${CFLAGS} -c abi_compatibility.cpp chrono_utils.cpp cmsg.cpp file.cpp hex.cpp logging.cpp mapped_file.cpp parsebool.cpp parsenetaddress.cpp posix_strerror_r.cpp process.cpp properties.cpp stringprintf.cpp strings.cpp threads.cpp test_utils.cpp ${src}
$AR rcs ../lib/libbase.a *.o
rm -r *.o
unset src

echo "BUILD libsparse"
cd ../libsparse
...
echo "BUILD fmtlib"
cd ../fmtlib
$CC -std=c++17 -I../include ${CFLAGS} -c src/format.cc
$AR rcs ../lib/fmtlib.a *.o
rm -r *.o

echo "BUILD liblp"
cd ../liblp
$CC -std=c++17 -I../include  -D_FILE_OFFSET_BITS=64 ${CFLAGS} -c builder.cpp super_layout_builder.cpp images.cpp partition_opener.cpp property_fetcher.cpp reader.cpp utility.cpp writer.cpp
...
echo "BUILD libcrypto_utils"
cd ../libcrypto_utils
$CC -Iinclude -I../boringssl/include ${CFLAGS} -c android_pubkey.cpp
...
crypto_sources_asm="apple-aarch64/crypto/chacha/chacha-armv8-apple.S\
